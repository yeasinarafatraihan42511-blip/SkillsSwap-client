...
export default function HeroSection() {
  ...
  if (!mounted) {
    return (
      <section className="h-[700px] bg-gradient-to-b from-slate-50 to-white flex items-center justify-center">
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-100">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-20 left-10 md:left-20 h-72 w-72 rounded-full bg-blue-500/20 blur-3xl"></div>

        <div className="absolute bottom-10 right-10 md:right-20 h-72 w-72 rounded-full bg-violet-500/20 blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-5 py-20 lg:py-32">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="mt-7 text-5xl md:text-6xl xl:text-7xl font-black leading-tight">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600 max-w-xl">
              ...
              Post tasks, receive competitive proposals,
              hire trusted freelancers and complete projects
              securely with SkillSwap.
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              {[
                ...
                <motion.div
                  ...
                  className="bg-white rounded-3xl border shadow-xl p-7"
                >
